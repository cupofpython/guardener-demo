...
1. Generate a GitHub IAM identity locally using chainctl by running: `chainctl iam identities create github gh --github-repo=cupofpython/guardener-test --github-ref=refs/heads/main --role=owner --github-audience=https://github.com/{GITHUB_USER}`
